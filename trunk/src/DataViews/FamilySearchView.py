...
# $Id: PedigreeView.py 10103 2008-02-24 13:55:55Z acraphae $
...
#
#-------------------------------------------------------------------------
class FamilySearchView(PageView.PersonNavView):

    def __init__(self,dbstate,uistate):
        PageView.PersonNavView.__init__(self, _('Family Search'), dbstate, uistate)
...
#            self.FSwebservice = apifunctions.FamilySearch()
            ...
            agentname = "legado"
            self.FSwebservice = familysearch_api.FamilySearch(url,key,agentname)
            if self.FSwebservice.login(username, password):
                print "logged to the API"
